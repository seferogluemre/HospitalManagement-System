...
export class AIOrchestratorService {
  ...
  static async generateTreatmentReport(
    ...
    try {
      ...
      const parseResult = ResponseParserService.parseAIResponse(aiResponse.data as string);
      ...
      const cleanedResponse = ResponseParserService.cleanResponse(parseResult.data);
  ...
  private static containsRiskyKeywords(text: string): boolean {
    const riskyKeywords = [
      'şiddetli', 'kronik', 'ciddi', 'tehlikeli', 
      'acil', 'hemen', 'derhal'
    ];
